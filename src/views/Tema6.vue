...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-lg-6
        .cajon.color-primario.p-4.mb-4(style='background-color: #ffd667')
          .row.justify-content-center
            .col-lg-3.col-3.mb-lg-0.mb-3: img(data-aos='zoom-in')(src='@/assets/curso/temas/tema6/3.svg', alt='')
            .col-lg-9
    ...
    .bg-gris.margin-n.p-5  
      ...
      .row.justify-content-center.mb-5
        .col-lg-8: img(data-aos='zoom-in')(src='@/assets/curso/temas/tema6/8.svg', alt='')
      p.mb-5(data-aos='fade-right') Finalmente, hay que recordar que:
      .row.justify-content-center.align-items-center.mb-5
        .col-lg-5
          .row.justify-content-center.mb-3.align-items-center
            .col-lg-2.col-3.mb-lg-0.mb-3: img(data-aos='zoom-in')(src='@/assets/curso/temas/tema6/n1.svg', alt='')
            .col-lg-10
              p El derecho de autor ampara obras, no ideas.
          hr
          .row.justify-content-center.mb-3.align-items-center
            .col-lg-2.col-3.mb-lg-0.mb-3: img(data-aos='zoom-in')(src='@/assets/curso/temas/tema6/n2.svg', alt='')
            .col-lg-10
              p Crear una obra de cualquier tipo ya es derecho del autor.
          hr
          .row.justify-content-center.mb-3.align-items-center
            .col-lg-2.col-3.mb-lg-0.mb-3: img(data-aos='zoom-in')(src='@/assets/curso/temas/tema6/n3.svg', alt='')
            .col-lg-10
              p Las creaciones colectivas de personas naturales tienen el derecho de autor.
          hr
          .row.justify-content-center.mb-3.align-items-center
            .col-lg-2.col-3.mb-lg-0.mb-3: img(data-aos='zoom-in')(src='@/assets/curso/temas/tema6/n4.svg', alt='')
            .col-lg-10
              p Si cede a derechos de autor legalice los fines, usos y aplicaciones para la obra.
        .col-lg-5
          .row.justify-content-center.mb-3.align-items-center
            .col-lg-2.col-3.mb-lg-0.mb-3: img(data-aos='zoom-in')(src='@/assets/curso/temas/tema6/n5.svg', alt='')
            .col-lg-10
              p Los derechos de autor patrimoniales son los que se ceden por reproducción, adaptación o publicación. 
          hr
          .row.justify-content-center.mb-3.align-items-center
            .col-lg-2.col-3.mb-lg-0.mb-3: img(data-aos='zoom-in')(src='@/assets/curso/temas/tema6/n6.svg', alt='')
            .col-lg-10
              p Es diferente ser dueño de una obra que tener derecho de autor.
          hr
          .row.justify-content-center.mb-3.align-items-center
            .col-lg-2.col-3.mb-lg-0.mb-3: img(data-aos='zoom-in')(src='@/assets/curso/temas/tema6/n7.svg', alt='')
            .col-lg-10
              p Es importante utilizar con autorización los trabajos de otros.
          hr
          .row.justify-content-center.mb-3.align-items-center
            .col-lg-2.col-3.mb-lg-0.mb-3: img(data-aos='zoom-in')(src='@/assets/curso/temas/tema6/n8.svg', alt='')
            .col-lg-10
